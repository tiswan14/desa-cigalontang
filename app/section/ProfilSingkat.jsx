    ...
    return (
        <section className='max-w-6xl mx-auto px-4 py-12'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8'>
                {/* Lokasi */}
                <div className='bg-white rounded-xl shadow-sm p-6 border border-emerald-100 hover:shadow-md transition-all'>
                ...
                <div className='bg-white rounded-xl shadow-sm p-6 border border-emerald-100 hover:shadow-md transition-all'>
                    ...
                    <p className='text-gray-600'>
                        <span className='text-emerald-600 font-bold'>8 RW</span>
                    </p>
                </div>
